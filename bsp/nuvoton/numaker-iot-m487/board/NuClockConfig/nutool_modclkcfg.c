...
USBH=Bus Clock(HCLK):192MHz/Engine Clock:192MHz
...
void nutool_modclkcfg_init_usbd(void)
{
    ...
    CLK_SetModuleClock(USBD_MODULE, MODULE_NoMsk, CLK_CLKDIV0_USB(1));
...
void nutool_modclkcfg_init_usbh(void)
{
    ...
    CLK_SetModuleClock(USBH_MODULE, MODULE_NoMsk, CLK_CLKDIV0_USB(1));
